<?php
    ...
    if(!empty($_POST))
    {
        ...
        if(empty($name))
        {
            $nameError = 'Ce champ ne peu pas être vide';
            $isSuccess = false;
        }
        if(empty($description))
        {
            $descriptionError = 'Ce champ ne peu pas être vide';
            $isSuccess = false;
        }
        if(empty($price))
        {
            $priceError = 'Ce champ ne peu pas être vide';
            $isSuccess = false;
        }
        if(empty($category))
        {
            $categoryError = 'Ce champ ne peu pas être vide';
            $isSuccess = false;
        }
        if(empty($image))
        {
        ...
        else
        {
            ...
            {
                $imageError = 'Les fichiers autorises sont : .png, .jpg, .jpeg, .gif';
        ...
        <div class="row">
            ...
            <form class="form" role="form" action="<?php echo'update.php?id=' . $id; ?>" method="post" enctype="multipart/form-data">
                ...
                <label for="price">Prix: (en ariary)</label>
                    <input type="number" step="0.100" class="form-control" id="price" name="price" placeholder="Prix" value="<?php echo $price; ?>">
            ...
            <div class="col-sm-6 site">
                <div class="thumbnail">
                    ...
                    <div class="price"><?php echo number_format((float)$price, 3, '.', '') . ' Ar'; ?></div>
                    <div class="caption">
                        <h4><?php echo $name ; ?></h4>
